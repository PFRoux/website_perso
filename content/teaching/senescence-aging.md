+++
slug = "Molecular basis of cellular senescence and aging"

# Date this page was created.
date = 2026-06-19T00:00:00

# Project title.
title = "Molecular basis of cellular senescence and aging"

# Project summary to display on homepage.
summary = "Lectures connecting senescence, p53 biology, metabolism, epigenetics and aging-related pathophysiology for Master-level biology and health students."

# Optional image to display on homepage (relative to `static/img/` folder).
image_preview = "research-senescence-systems.jpg"

# Tags: can be used for filtering projects.
tags = ["Cellular senescence", "Aging", "Epigenetics", "Metabolism", "p53"]
